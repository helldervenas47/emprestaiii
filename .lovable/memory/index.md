...
- [Default public signup role](mem://features/default-public-signup-role) — Public signups must automatically get only the Cliente role
...
- [Salary income category](mem://features/salary-income-category) — Treat "Salário" and "Salários" as one income category; save/display/aggregate as "Salário"
