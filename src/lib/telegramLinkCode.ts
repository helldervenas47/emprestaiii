...
// As funções usam o mesmo projeto Supabase do cliente principal.
...
if (!APP_FUNCTIONS_URL || !APP_FUNCTIONS_PUBLISHABLE_KEY) {
  throw new Error("[telegram] VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY são obrigatórios para chamar as funções do app.");
}
