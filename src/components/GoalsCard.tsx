...
const GOAL_TYPE_META: Record<GoalType, { label: string; icon: any; unit: Unit; color: string; bgColor: string; description: string; inverse?: boolean }> = {
  ...
  interest_received:  { label: "Média Recebida por Dia",                  icon: Coins,         unit: "R$",  color: "text-success",     bgColor: "bg-success/15",     description: "Apenas a parte dos juros dos pagamentos Recebidos." },
  ...
  daily_received_avg: { label: "Média PAGA por Dia",           icon: HandCoins,     unit: "R$",  color: "text-success",     bgColor: "bg-success/15",     description: "Meta mensal com média diária e necessário/dia restante." },
};
            ...
            {visibleGoals.map((g) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1.5 sm:flex-row sm:items-center sm:gap-2 sm:pr-7">
