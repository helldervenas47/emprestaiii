    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const items = [
          ...
          { label: "Total a Receber", value: formatCurrency(portfolio.pendingReceivable), color: "text-foreground", iconBg: "bg-primary/10", iconColor: "text-primary", onClick: undefined as (() => void) | undefined },
