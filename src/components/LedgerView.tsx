      ...
      <Card no3d>
        <CardContent className="p-3 sm:p-5">
          <div className="flex flex-col items-center text-center">
            <div className="h-8 w-8 sm:h-14 sm:w-14 rounded-full bg-primary/10 flex items-center justify-center mb-1 sm:mb-2">
              <Wallet className="h-4 w-4 sm:h-7 sm:w-7 text-primary" />
            </div>
            <p className="text-[11px] sm:text-sm text-muted-foreground">Saldo Total</p>
            <p className={`text-base sm:text-3xl font-bold mt-0.5 sm:mt-1 ${balances.total < 0 ? "text-destructive" : "text-foreground"}`}>
              {formatBRL(balances.total)}
            </p>
          </div>

          <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-3 sm:mt-4">
            <div className="rounded-xl border border-border/40 bg-muted/30 p-2.5 sm:p-4">
              ...
              <p className={`text-sm sm:text-xl font-bold truncate ${balances.account < 0 ? "text-destructive" : "text-foreground"}`}>
            ...
            <div className="rounded-xl border border-border/40 bg-muted/30 p-2.5 sm:p-4">
              ...
              <p className={`text-sm sm:text-xl font-bold truncate ${balances.cash < 0 ? "text-destructive" : "text-foreground"}`}>
