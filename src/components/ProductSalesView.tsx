...
export function ProductSalesView({ sales, onDeleteSale, onUpdateSale, clients = [], expenses = [], onAddExpense, onPayExpense, onDeleteExpense, onUpdateExpense }: Props) {
  ...
  const secondaryCards = (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-center gap-2 rounded-xl border p-3 bg-card">
        ...
        <button
          className="text-sm font-medium text-foreground capitalize hover:text-primary transition-colors min-w-[140px] text-center"
          onClick={() => {
            const n = new Date();
