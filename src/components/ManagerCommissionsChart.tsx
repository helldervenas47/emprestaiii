            ...
            {data.map((m) => (
              ...
              >
                <div className="flex flex-col items-center gap-1.5 sm:flex-row sm:items-center sm:gap-2">
                  <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-md bg-emerald-600/20 dark:bg-emerald-500/25 flex items-center justify-center shrink-0">
                    <UserCog className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-emerald-800 dark:text-emerald-300" />
                  </div>
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <UserCog className="h-5 w-5 text-emerald-800 dark:text-emerald-300" />
