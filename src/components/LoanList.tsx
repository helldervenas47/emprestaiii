        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {loan.hasManager && (
                <Badge variant="outline" className="bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/40 text-[9px] sm:text-[10px] px-1 py-0 gap-0.5 shrink-0" title="Com gerente">
