      ...
      <CardContent className="p-4 flex-1 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {loan.hasManager && (
              <Badge variant="outline" className="text-xs bg-emerald-500/25 text-emerald-700 dark:text-emerald-300 border-emerald-500/60 gap-1">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {loan.hasManager && (
                <Badge variant="outline" className="bg-emerald-500/25 text-emerald-700 dark:text-emerald-300 border-emerald-500/60 text-[9px] sm:text-[10px] px-1 py-0 gap-0.5 shrink-0" title="Com gerente">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {managerCount > 0 && (
              <Badge variant="outline" className="bg-emerald-500/25 text-emerald-700 dark:text-emerald-300 border-emerald-500/60 text-[10px] gap-0.5">
