  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        <Button
          variant="outline"
          className="w-full h-12 rounded-xl text-base font-medium gap-3 border-input hover:border-[#4285F4] hover:bg-gradient-to-r hover:from-[#4285F4]/10 hover:via-[#34A853]/10 hover:to-[#FBBC05]/10 hover:text-[#4285F4] hover:shadow-[0_0_0_2px_rgba(66,133,244,0.3)] transition-all duration-300"
