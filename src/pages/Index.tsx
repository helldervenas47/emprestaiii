...
const Index = () => {
  ...
  const needsProducts = tab === "overview" || tab === "products" || tab === "vehicles" || tab === "calendar" || tab === "settings";
  const needsExpenses = tab === "overview" || tab === "expenses" || tab === "vehicles" || tab === "overdue" || tab === "accountant" || tab === "settings";
...
<AppLogo area="header" alt={brandName} className="w-auto hidden md:block" />
      ...
      {!isReadOnly && primaryLabel && (tab === "dashboard" || tab === "expenses" || tab === "products" || tab === "vehicles" || (tab === "clients" && clientSubTab === "clientes")) && (
        ...
        >
          <Plus className="h-5 w-5 relative z-10 drop-shadow-[0_1px_2px_hsl(var(--primary)/0.5)]" strokeWidth={2.75} />
        </button>
      )}
      {!isReadOnly && tab === "vehicles" && (
        ...
        >
          <Receipt className="h-4 w-4 relative z-10" strokeWidth={2.5} />
        </button>
      )}
