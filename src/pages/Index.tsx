...
<img src={logoIcon} alt="EmprestAI" className="h-[34px] w-auto object-contain shrink-0" />
                      <div>
            ...
            <img src={logoIcon} alt="EmprestAI" className="h-[42px] w-auto object-contain shrink-0" />
