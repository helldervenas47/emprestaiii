    ...
    const promptByType: Record<ReportType, { system: string[]; userIntro: string }> = {
      "risk-reduction": {
        system: [
          ...
          "Estruture a resposta com estes blocos: Resumo executivo, Principais riscos, Ações imediatas, Ajustes recomendados, Alerta final.",
          "O relatório deve ser bem resumido, com informações claras, diretas e acionáveis.",
          "Limite cada bloco a no máximo 2 bullets curtos e priorize apenas o que mais impacta a redução de risco.",
